  ...
  const steps: TimelineStep[] = [
    {
      key: "CREATED",
      label: "Kreiran",
      description: "Transportni nalog je kreiran u sistemu",
      timestamp: createdAt,
    },
    {
      key: "ASSIGNED",
      label: "Dodijeljen",
      description: "Transportni nalog je dodijeljen vozaču i kamionu",
      timestamp: assignedAt || scheduledPickupDate,
    },
    {
      key: "PICKUP",
      label: "Preuzimanje",
      description: "Planirano ili stvarno preuzimanje",
      timestamp: actualPickupDate || scheduledPickupDate,
    },
    {
      key: "IN_TRANSIT",
      label: "U transportu",
      description: "Vozilo je na putu između lokacije preuzimanja i isporuke",
      timestamp: inTransitAt || actualPickupDate || scheduledPickupDate,
    },
    {
      key: "DELIVERY",
      label: "Isporuka",
      description: "Planirana ili stvarna isporuka",
      timestamp: actualDeliveryDate || scheduledDeliveryDate,
    },
    {
      key: "COMPLETED",
      label: "Završen",
      description: "Transportni nalog je u potpunosti završen",
