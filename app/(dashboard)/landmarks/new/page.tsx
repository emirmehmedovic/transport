...
import { getLandmarkIcon, getLandmarkLabel } from "@/lib/landmark-icons";
...
export default function NewLandmarkPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) {
        throw new Error(data.error || "Greška pri kreiranju tačke");
      }
    ...
    <div className="max-w-5xl mx-auto px-4 py-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-slate-600 mt-2">
          Dodajte novu važnu lokaciju ili tačku od interesa
        </p>
      </div>
