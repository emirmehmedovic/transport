    ...
    <div className="space-y-4 md:space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-4">
        <div className="bg-red-50 rounded-lg p-3 md:p-4 border border-red-200">
          <p className="text-xs md:text-sm text-red-600 font-medium mb-1">Urgent (≤7 days)</p>
        ...
        <div className="bg-yellow-50 rounded-lg p-3 md:p-4 border border-yellow-200">
          <p className="text-xs md:text-sm text-yellow-600 font-medium mb-1">Warning (7-15 days)</p>
          <p className="text-xl md:text-2xl font-bold text-yellow-700">{expiringDocs.warning}</p>
        </div>
        <div className="bg-blue-50 rounded-lg p-3 md:p-4 border border-blue-200">
          <p className="text-xs md:text-sm text-blue-600 font-medium mb-1">Info (15-30 days)</p>
